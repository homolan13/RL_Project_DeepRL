    ...
    def train(self, batch_size=32, target_update_period=100, max_iter=1000, max_patience=100):
        ...
        for it in range(max_iter):
            ...
            while not done:
                ...
                state = next_state
                minutes_until_death += 3
            
            print(f'Patient died after {minutes_until_death} minutes')
            ...
            if it % 5 == 0:
                print(f'\nIteration: {it+1}, Critic loss: {critic_loss.item():.3f} (min: {min_critic_loss:.3f}), Patience left: {patience}\n')
