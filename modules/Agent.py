...
class DDPGAgent(object):
    ...
    def general_training(self, batch_size=32, target_update_period=100, iter=[300, 1000], max_patience=200, path='agent_state'):
    ...
    def personalized_training(self, batch_size=32, target_update_period=100, iter=[200, 700], max_patience=100, path='agent_state_finetuned'):
